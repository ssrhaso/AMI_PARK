...
def train():
    ...
    for epoch in range(epochs):
        total_loss = 0.0
        for s, a, target_delta in loader:
            optimizer.zero_grad()
            pred_delta = model(s, a)  # Predict delta
